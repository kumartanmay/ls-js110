...
Remarks
    ...
    Dart, Elixir, Fortran, F#, Haskell, Nim, OCaml, Pascal, Perl, PowerShell, Prolog, PureScript, R, Racket, Rust, Shell, Swift).
...
function comp(array1, array2){
  //your code here
  // create a new array which has elements as squared of array1
  // check if each element of array2 is in the squared array
  if(array1 && array2) {
    let squaredArray1 = array1.map(elem => elem * elem);
    return array2.every(elem => {
     if (squaredArray1.includes(elem)) {
       squaredArray1.splice(squaredArray1.indexOf(elem),1)
       return true;
     }
    });
  }
